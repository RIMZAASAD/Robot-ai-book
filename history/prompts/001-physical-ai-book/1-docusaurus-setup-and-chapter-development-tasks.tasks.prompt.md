...
user: user
command: /sp.tasks
labels: [docusaurus, setup, chapter, lessons, tasks]
links:
...
is running ..Break down the plan into specific executable tasks as a checklist .Include:
...
- [ ] T010 Set up navigation structure in `sidebars.js`
...
- 📁 Files: Updated ./specs/001-physical-ai-book/tasks.md with comprehensive task list
